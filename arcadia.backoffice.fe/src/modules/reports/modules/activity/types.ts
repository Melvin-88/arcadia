...
export interface IActivityReportItem {
...
export type IActivityReport = IActivityReportItem[];

export interface IGetActivityReportResponseBody extends IReportResponseBody<IActivityReport> {
}

export interface IActivityReportReducer extends IGetActivityReportResponseBody {
