...
interface IMachineStatusReportFiltersProps extends IModuleFiltersProps<IReportsFiltersPanelValues> {
}

export const MachineStatusReportFilters: React.FC<IMachineStatusReportFiltersProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <MachinesStatusField label="Status" />
    </ModuleFilters>
  );
};
