...
// TODO: Complete "CSRTCPlayer" declaration after Video API stabilize BEGIN
declare interface Window {
  CSRTCPlayer: any
}
// TODO: Complete "CSRTCPlayer" declaration after Video API stabilize END

// TODO: Complete "BlueRibbon" usage stabilized BEGIN
declare interface Window {
  BlueRibbon: {
    constants: {
      events: {
        WIN_EVENT: string
        POT_STATE_CHANGED_EVENT: string
        GAME_DETAILS_CHANGED_EVENT: string
        OPT_IN_EVENT: string
        OPT_OUT_EVENT: string
        GAME_CODE_MATCHING_STATE_CHANGED_EVENT: string
        GAME_STATUS_CHANGED_EVENT: string
        CONNECTION_ACTIVITY_CHANGED: string
      }
      gamesMode: {
        LOBBY: string
        IN_GAME: string
...
// TODO: Complete "Winwheel" declaration after FortuneWheel feature complete BEGIN
declare interface Window {
  Winwheel: any
}
// TODO: Complete "Winwheel" declaration after FortuneWheel feature complete END

// TODO: Extract "spine" declarations to the separate file BEGIN
...
// TODO: Extract "spine" declarations to the separate file END
