...
declare namespace ReactSlider {
  interface ReactSliderProps<TValue = number> {
    /**
     ...
     */
    onBeforeChange?: (value: TValue | undefined | null) => void;
    /**
     ...
     */
    onAfterChange?: (value: TValue | undefined | null) => void;
    /**
     ...
     */
    ariaValuetext?: string | ((value: {index: number; value: TValue; valueNow: number }) => string);
    /**
     ...
     */
    renderTrack?: (props: object, state: {index: number; value: TValue }) => JSX.Element;
    /**
     * Provide a custom render function for dynamic thumb content.
     * The render function will be passed two arguments.The first is
     * an object that should be added to your thumb node,
     */
    renderThumb?: (props: object, state: {index: number; value: TValue; valueNow: number }) => JSX.Element;
  }
}
