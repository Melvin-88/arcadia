...
export interface IBetBehindSnackbarStyleProps {
}

export interface IBetBehindSnackbarStyles {
  headerIcon: IStyle;
...
export const getStyles = (): IBetBehindSnackbarStyles => ({
  headerIcon: {
    display: 'block',
    width: '7.5rem',
    marginRight: '1.79rem',
...
export const getClassNames = classNamesFunction<IBetBehindSnackbarStyleProps, IBetBehindSnackbarStyles>();
